#!/bin/bash -xe
upload_log() {
  aws s3 cp /tmp/userdata_execution.log s3://s3datacapturetestconnector/logs/
}
...
aws s3 cp s3://s3datacapturetestconnector/codebase /home/ubuntu/dags --recursive
unzip -d /home/ubuntu/dags /home/ubuntu/dags/elt_runner_0.1.zip
